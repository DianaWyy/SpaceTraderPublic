public enum Item {
    ...
    HOE("Hoe", 25, TechLevel.AGRICULTURE),
    ...
    ARGFUEL("Argiculture Fuel", 30, TechLevel.AGRICULTURE),
    ARGTAPE("Argiculture Tape", 30, TechLevel.AGRICULTURE),
    //MEDIEVAL
    ...
    SILVER("Siver", 90, TechLevel.MEDIEVAL),
    ...
    INDUSFUEL("Industral Fuel", 600, TechLevel.INDUSTRIAL),
    INDUSTAPE("Industral Tape", 600, TechLevel.INDUSTRIAL),
    //MODERN
    ...
    MODFUEL("Modren Fuel", 3000, TechLevel.MODERN),
    MODTAPE("Modren Tape", 3000, TechLevel.MODERN),
    //FUTURISTIC
    DORAEMON("Doraemon", 5000, TechLevel.FUTURISTIC),
    GLASSSCREEN("GlassScreen", 5000, TechLevel.FUTURISTIC),
    FUFUEL("Fururistic Fuel", 5000, TechLevel.FUTURISTIC),
    FUTAPE("Fururistic Tape", 5000, TechLevel.FUTURISTIC),
    SUPERMAN("Superman", 5500, TechLevel.FUTURISTIC),
    BATMAN("Batman", 6000, TechLevel.FUTURISTIC),
    IRONMAN("Ironmen", 6000, TechLevel.FUTURISTIC),

    ...
    public LoginPage() throws IOException {
        ...
        next.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                if (name.equals("") || (!easy.isSelected()
                        && !medium.isSelected() && !hard.isSelected())) {
                    ...
                    new DisplayPage(name, difficulty, credits, pilotSkill,
                            fighterSkill, merchantSkill, engineerSkill);
                    f.dispose();
                }
            }
        });
